...
directory_path = '/euopen/screeningunit/Bioactives/Transfer/FMP_HepG2/'
...
key_file[['replicate_number', 'plate_name', 'imaging_date', 'imaging_time']] = key_file['Assay_Plate_Barcode'].apply(lambda x: pd.Series(extract_parts(x)))
