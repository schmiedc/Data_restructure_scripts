...
# specific to USC HepG2
def get_load_data_USC_HepG2(plate_path, aws_plate_path, aws_illum_corr_path, batch, plate, rows):
        ...
        for file_name in os.listdir(images_path):
            ...
            if file_name.endswith(".tiff"):
                ...
                if int(channel_number) == 1:
                    ...
                    # This naming scheme is specific to USC HepG2
                    namesplit_file_name = file_name.split("-")
                    file_name_DNA = namesplit_file_name[0] + "-ch1sk1fk1fl1.tiff"
                    file_name_ER = namesplit_file_name[0] + "-ch2sk1fk1fl1.tiff"
                    file_name_AGP = namesplit_file_name[0] + "-ch3sk1fk1fl1.tiff"
                    file_name_Mito = namesplit_file_name[0] + "-ch4sk1fk1fl1.tiff"
...
for batch in batch_name_list:
    ...
    for assay_plate_barcode_load in full_plate_name_list:
        ...
        if barcode_filtered_key_file_load.shape[0] == 1:
            ...
            load_data_with_illum = get_load_data_USC_HepG2(full_plate_name_path,
